...
<div class="container my-5">
    <div class="mb-4">
        <a href="{{ route('admin.pka') }}" class="btn btn-secondary">
    ...
    @foreach($angkatanList as $angkatan)
        <div class="row">
            <div class="col-4 col-md-3 mb-3">
                ...
                <a href="{{ route('admin.pka-book', ['tahun' => $tahunDipilih, 'angkatan' => $angkatan->angkatan]) }}" class="btn btn-danger btn-lg w-100 py-4">
                    {{ $angkatan->angkatan }}
                </a>
            </div>
        </div>
