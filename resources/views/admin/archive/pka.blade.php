...
<div class="container my-5">
    <!-- Tombol Kembali -->
    <div class="mb-4">
        <a href="{{ route('admin.archive') }}" class="btn btn-secondary">
    ...
    <div class="row text-center">
        ...
        @foreach($tahunList as $tahun)
            <div class="col-4 col-md-3 mb-3">
                ...
                <a href="{{ url('/admin/pka-angkatan?tahun=' . $tahun->tahun) }}" class="btn btn-danger btn-lg w-100 py-4">{{ $tahun->tahun }}</a>
            </div>
        @endforeach
    </div>
</div>
