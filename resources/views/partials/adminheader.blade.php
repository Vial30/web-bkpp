<header class="d-flex justify-content-between align-items-center py-3 px-4">
    ...
    <div class="profile-dropdown-wrapper">
        <button class="btn btn-light" id="dropdownButton">{{ Auth::user()->name }}</button>
        ...
        <div class="dropdown" id="dropdownMenu">
            ...
            <!-- Menu Item -->
            <ul>
                <li><a href="{{ url('/admin/account') }}">Akun</a></li>
                <li><a href="{{ url('/admin/import') }}">Tambah Kegiatan</a></li>
